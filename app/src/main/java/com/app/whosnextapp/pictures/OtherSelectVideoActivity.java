...
public class OtherSelectVideoActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    private Activity getActivity() {
        return OtherSelectVideoActivity.this;
    }
...
//        finish();
    ...
    private void setPostData(PostDetailsModel postDetailsModel) {
        ...
        if (postDetailsModel.getPostDetail().getIsImage()) {
            ...
            //  player.getLayoutParams().height=postDetailsModel.getPostDetail().getPostHeight();
