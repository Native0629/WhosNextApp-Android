...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.ViewHolder> {
    ...
    private FollowerAdapter.OnCustomClickListener onCustomClickListener;

    FollowerAdapter(Context context, FollowerAdapter.OnCustomClickListener onCustomClickListener) {
    ...
    @NonNull
    @Override
    public FollowerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    public interface OnCustomClickListener {
        ...
        void onClickRequestedButton(int position, View v);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void setDataToView(GetFollowersListModel.CustomerList customerList) {
            ...
            if (customerList.getIsRequested()) {
                btn_follower.setText(R.string.requested);
            } else {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_follower:
                    ...
                    else if (btn_follower.getText().equals(context.getResources().getString(R.string.requested)))
                        onCustomClickListener.onClickRequestedButton(getAdapterPosition(), v);
                    break;
            }
        }
    }
