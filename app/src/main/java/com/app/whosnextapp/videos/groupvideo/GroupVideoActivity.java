...
public class GroupVideoActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    public void onSubmitClick() {
        ...
        imgWidth = Integer.valueOf(retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_WIDTH));
        imgHeight = Integer.valueOf(retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_HEIGHT));
        i.putExtra(Constants.WN_POST_HEIGHT, imgHeight);
        i.putExtra(Constants.WN_POST_WIDTH, imgWidth);
