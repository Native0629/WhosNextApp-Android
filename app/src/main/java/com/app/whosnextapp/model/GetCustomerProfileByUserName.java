...
public class GetCustomerProfileByUserName implements Serializable {

    @SerializedName("CustomerDetail")
    private CustomerDetail CustomerDetail;

    public GetCustomerProfileByUserName.CustomerDetail getCustomerDetail() {
        return CustomerDetail;
    }

    public void setCustomerDetail(GetCustomerProfileByUserName.CustomerDetail customerDetail) {
