...
public class GetAllLikesByPostIdModel implements Serializable {

    @SerializedName("CustomerList")
    private ArrayList<CustomerList> CustomerList;

    public ArrayList<GetAllLikesByPostIdModel.CustomerList> getCustomerList() {
        return CustomerList;
    }

    public void setCustomerList(ArrayList<GetAllLikesByPostIdModel.CustomerList> customerList) {
