...
public class AddPostCommentModel implements Serializable {

    @SerializedName("PostCommentDetail")
    private PostCommentDetail PostCommentDetail;

    public PostCommentDetail getPostCommentDetail() {
        return PostCommentDetail;
    }

    public void setPostCommentDetail(PostCommentDetail PostCommentDetail) {
        this.PostCommentDetail = PostCommentDetail;
    }

    public static class PostCommentDetail implements Serializable {
