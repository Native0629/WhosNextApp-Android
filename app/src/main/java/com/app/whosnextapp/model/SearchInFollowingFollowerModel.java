...
public class SearchInFollowingFollowerModel implements Serializable {

    @SerializedName("CustomerList")
    private ArrayList<CustomerList> CustomerList;

    public ArrayList<SearchInFollowingFollowerModel.CustomerList> getCustomerList() {
        return CustomerList;
    }

    public void setCustomerList(ArrayList<SearchInFollowingFollowerModel.CustomerList> customerList) {
