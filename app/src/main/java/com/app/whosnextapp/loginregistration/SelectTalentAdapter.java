...
class SelectTalentAdapter extends RecyclerView.Adapter<SelectTalentAdapter.CustomViewHolder> implements Filterable {
    ...
    SelectTalentAdapter(Context context, OnFilterApplyListener listener) {
