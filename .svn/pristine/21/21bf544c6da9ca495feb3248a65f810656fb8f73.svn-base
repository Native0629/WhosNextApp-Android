...
import com.app.whosnextapp.pictures.OtherSelectVideoActivity;
...
public class OtherUserProfileActivity extends BaseAppCompatActivity implements View.OnClickListener, AllPostAdapter.OnItemClick {
    ...
    GetProfileByCustomerIdModel getProfileByCustomerIdModel;
    ...
    private void doRequestToProfileDetails() {
        ...
        new PostRequest(this, null, requestURL, true, true, new ResponseListener() {
            ...
            public void onSucceedToPostCall(String response) {
                getProfileByCustomerIdModel = new Gson().fromJson(response, GetProfileByCustomerIdModel.class);
    ...
    private void setCommentAdapter(ArrayList<GetAllPostByCustomerIDModel.PostList> posts) {
        if (allPostAdapter == null) {
            allPostAdapter = new AllPostAdapter(OtherUserProfileActivity.this, this);
        }
    ...
    public void doRequestForgetPost() {
        final String requestURL = String.format(getString(R.string.get_all_post_by_other_customerId), 1, cid);
        new PostRequest(this, null, String.format(getString(R.string.get_all_post_by_other_customerId), 1, customer_id), true, true, new ResponseListener() {
            @Override
            public void onSucceedToPostCall(String response) {
            ...
            @Override
            public void onFailedToPostCall(int statusCode, String msg) {
                Globals.showToast(OtherUserProfileActivity.this, msg);
            }
        }).execute(globals.getUserDetails().getStatus().getUserId());
    }
    ...
    public void selectImage(GetAllPostByCustomerIDModel.PostList postList) {
        if (postList.getIsImage()) {
            Intent intent = new Intent(this, OtherSelectImageActivity.class);
            ...
            Intent intent = new Intent(this, OtherSelectVideoActivity.class);
            intent.putExtra(Constants.WN_POSTS_URL, postList.getPostUrl());
            intent.putExtra(Constants.WN_POST_ID, String.valueOf(postList.getPostId()));
            intent.putExtra(Constants.WN_IS_IMAGE, postList.getIsImage());
            intent.putExtra(Constants.WN_TOTAL_LIKES, postList.getTotalLikes());
