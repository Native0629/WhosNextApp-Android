...
public class MentionSpan extends ClickableSpan implements Parcelable {
    ...
    private OnMentionCLickEvent event;
    ...
    public MentionSpan(@NonNull Mentionable mention, MentionSpanConfig config, OnMentionCLickEvent event) {
        super();
        this.mention = mention;
        this.config = config;
        this.event = event;
    ...
    public interface OnMentionCLickEvent {
