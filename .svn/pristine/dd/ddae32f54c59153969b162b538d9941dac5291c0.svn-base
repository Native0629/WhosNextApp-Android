...
public class TabFeedGroupVideoAdapter extends RecyclerView.Adapter<TabFeedGroupVideoAdapter.ViewHolder> {

    private Context context;
    private ArrayList<GroupVideoModel> groupVideoModels;
    private OnGroupVideoClickListener clickListener;

    TabFeedGroupVideoAdapter(Context context, ArrayList<GroupVideoModel> groupVideoModels, TabFeedGroupVideoAdapter.OnGroupVideoClickListener clickListener) {
    ...
    @NonNull
    @Override
    public TabFeedGroupVideoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
