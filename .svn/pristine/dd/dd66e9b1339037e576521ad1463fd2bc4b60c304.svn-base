...
public class ExoPlayerViewHelper extends ToroPlayerHelper {
    ...
    @Deprecated  //
    public ExoPlayerViewHelper(Container container, @NonNull ToroPlayer player, @NonNull Uri uri, @NonNull ArrayList<Uri> videoList) {
        this(player, uri, videoList);
    }
    ...
    public ExoPlayerViewHelper(@NonNull ToroPlayer player, @NonNull Uri uri, @NonNull ArrayList<Uri> videoList) {
        this(player, uri, null, videoList);
    }

    @SuppressWarnings("WeakerAccess")
    public ExoPlayerViewHelper(@NonNull ToroPlayer player, @NonNull Uri uri, @Nullable String fileExt, @Nullable ArrayList<Uri> videoList) {
        this(player, uri, fileExt, with(player.getPlayerView().getContext()).getDefaultCreator(), videoList);
    }

    /**
     * Config instance should be kept as global instance.
     */
    public ExoPlayerViewHelper(@NonNull ToroPlayer player, @NonNull Uri uri, @Nullable String fileExt, @NonNull Config config, ArrayList<Uri> uris) {
        this(player, uri, fileExt, with(player.getPlayerView().getContext()).getCreator(checkNotNull(config)), uris);
    }

    @SuppressWarnings("WeakerAccess")
    public ExoPlayerViewHelper(@NonNull ToroPlayer player, @NonNull Uri uri, @Nullable String fileExt, @NonNull ExoCreator creator, @NonNull ArrayList<Uri> videoList) {
        this(player, new ExoPlayable(creator, uri, fileExt, videoList));
    }
