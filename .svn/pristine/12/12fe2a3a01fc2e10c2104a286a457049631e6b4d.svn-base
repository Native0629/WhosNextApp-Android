...
public class HttpRequestHandler {
    ...
    public JSONObject getRegisterJson(String CategoryIds, String CategoryNames, String ProfilePicBase64String,
                                      ...
                                      String UserName, String DeviceToken, String Email, String FirstName, int postWidth, int postHeight) {
        JSONObject paramObject = new JSONObject();
        try {
            paramObject.put(Constants.WN_CUSTOMER, getRegisterDetails(CategoryIds, CategoryNames, ProfilePicBase64String, BioVideoBase64String,
                    LastName, DeviceType, Password, UserName, DeviceToken, Email, FirstName, postWidth, postHeight));
    ...
    private JSONObject getRegisterDetails(String categoryIds, String categoryNames, String ProfilePicBase64String,
        ...
        try {
            ...
            paramObject.put(Constants.WN_POST_HEIGHT, postHeight);
            paramObject.put(Constants.WN_POST_WIDTH, postWidth);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return paramObject;
    ...
    public JSONObject getUpdateProfileJson(String CategoryIds, String ProfilePicBase64String, String Email, String UserName, String ProfilePicUrl, String FirstName, String CustomerId, String BioVideoBase64String, String CategoryNames, String AboutSelf, String LastName, String City, String Website, int postWidth, int postHeight) {
        JSONObject paramObject = new JSONObject();
        try {

            paramObject.put(Constants.WN_CUSTOMER, getUserUpdateDetails(CategoryIds, ProfilePicBase64String, Email, UserName, ProfilePicUrl, FirstName, CustomerId, BioVideoBase64String, CategoryNames, AboutSelf, LastName, City, Website,postWidth,postHeight));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return paramObject;
    ...
    private JSONObject getUserUpdateDetails(String CategoryIds, String ProfilePicBase64String, String Email, String UserName, String ProfilePicUrl, String FirstName, String CustomerId, String BioVideoBase64String, String CategoryNames, String AboutSelf, String LastName, String City, String Website, int postWidth, int postHeight) {
        JSONObject paramObject = new JSONObject();
        try {
            paramObject.put(Constants.WN_CATEGORY_IDS, CategoryIds);
