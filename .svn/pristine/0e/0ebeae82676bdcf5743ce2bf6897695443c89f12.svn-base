...
public class Container extends RecyclerView {
    ...
    public interface Filter {
        ...
        Filter PLAYING = new Filter() {
            @Override
            public boolean accept(@NonNull ToroPlayer player) {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<Container>
        ...
        @Override
        public boolean blocksInteractionBelow(CoordinatorLayout parent, Container child) {
        ...
        @Override
        public boolean onDependentViewChanged(CoordinatorLayout parent, Container child,
                                              View dependency) {
        ...
        @Override
        public boolean onMeasureChild(CoordinatorLayout parent, Container child,
        ...
        @Override
        public void onRestoreInstanceState(CoordinatorLayout parent, Container child,
                                           Parcelable state) {
            delegate.onRestoreInstanceState(parent, child, state);
        }

        @Override
        public Parcelable onSaveInstanceState(CoordinatorLayout parent, Container child) {
