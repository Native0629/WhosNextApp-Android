...
public class SelectTalentActivity extends BaseAppCompatActivity implements TextWatcher, SelectTalentAdapter.OnFilterApplyListener, View.OnClickListener {
    ...
    SelectTalentAdapter selectTalentAdapter;
    ...
    private void doRequestForTalentCategory() {
        new PostRequest(this, null, getString(R.string.get_talent_category_url), true, true, new ResponseListener() {
            ...
            public void onFailedToPostCall(int statusCode, String msg) {
                Globals.showToast(SelectTalentActivity.this, getString(R.string.msg_NO_INTERNET_TITLE));
            }
        }).execute();
    }
    ...
    public void setCategoryAdapter() {
        if (selectTalentAdapter == null) {
            selectTalentAdapter = new SelectTalentAdapter(this, listener);
        }
