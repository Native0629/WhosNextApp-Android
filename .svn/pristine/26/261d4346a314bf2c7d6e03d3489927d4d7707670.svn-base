...
public class Globals extends CoreApp {
    ...
    public static WordTokenizerConfig getTokenizerConfig(String word) {
        return new WordTokenizerConfig
                ...
                .setExplicitChars(Constants.WN_MentionPrefix)
                .setMaxNumKeywords(1)
                .setThreshold(1)
                .build();
    }
    ...
    //create circle
    public static GradientDrawable getCircle(int strokeColor, int strokeWidth, int fillColor) {
        GradientDrawable gD = new GradientDrawable();
        gD.setShape(GradientDrawable.RECTANGLE);
        gD.setCornerRadius(getContext().getResources().getDimension(R.dimen.dim_7));
