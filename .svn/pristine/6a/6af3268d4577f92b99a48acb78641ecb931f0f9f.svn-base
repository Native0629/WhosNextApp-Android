...
public class FeaturedProfileGroupVideoAdapter extends RecyclerView.Adapter<FeaturedProfileGroupVideoAdapter.ViewHolder> {
    private Context context;
    private ArrayList<GroupVideoModel> groupVideoModels;
    private TabFeedGroupVideoAdapter.OnGroupVideoClickListener clickListener;

    FeaturedProfileGroupVideoAdapter(Context context, ArrayList<GroupVideoModel> groupVideoModels, TabFeedGroupVideoAdapter.OnGroupVideoClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        viewHolder.setDataToView(groupVideoModels.get(i));
    }
    ...
    private void handleSelection(int adapterPosition) {
        ...
        groupVideoModels.get(adapterPosition).isSelected = true;
