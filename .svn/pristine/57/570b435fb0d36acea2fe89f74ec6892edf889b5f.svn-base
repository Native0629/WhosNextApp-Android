...
//                }
    ...
    public void insertMention(@NonNull Mentionable mention) {
        ...
        text.append("@");
        // Spannable spannableText =new SpannableString(text.toString());
        // spannableText.setSpan(new ForegroundColorSpan(Color.parseColor("#FE2E1C")), 0, text.length(),  Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        text.setSpan(new ForegroundColorSpan(Color.parseColor("#FE2E1C")), 0, text.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        int cursor = getSelectionStart();
        int start = mTokenizer.findTokenStart(text, cursor);
        int end = mTokenizer.findTokenEnd(text, cursor);
